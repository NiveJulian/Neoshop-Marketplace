...
export default function Dashboard({ user }) {
  ...
  const fetchDataPaying = async () => {
    try {
      const response = await axios.get(`https://neoshop-backend.vercel.app/paying/all`);
  ...
  const fetchDataProducts = async () => {
    try {
      const response = await axios.get(`https://neoshop-backend.vercel.app/product/`);
  ...
  const fetchDatastores = async () => {
    try {
      const response = await axios.get(`https://neoshop-backend.vercel.app/store/`);
