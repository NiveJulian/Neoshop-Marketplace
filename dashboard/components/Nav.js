...
export default function Nav({ show, userId, user, isAdmin }) {
      ...
      <div className="w-full px-6">
        <nav className="flex flex-col gap-2">
          ...
          {isAdmin && (
            <>
              <Link
                href={`/admin/stores/${userId}`}
                className={
                  pathname.includes("/stores") ? activeLink : inactiveLink
                }
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  ...
                  stroke="currentColor"
                  className={
                    pathname.includes("/stores") ? activeIcon : inactiveIcon
                  }
                >
                  <path
                    strokeLinecap="round"
              ...
              >
                <svg
                  ...
                  stroke="currentColor"
                  className={
                    pathname.includes("/user") ? activeIcon : inactiveIcon
                  }
                >
                  <path
                    strokeLinecap="round"
