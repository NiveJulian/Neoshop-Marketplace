...
export const AdressUser = () => {
  ...
  const handleSubmit = (e) => {
    ...
    try {
      ...
      dispatch(updateUserAddress(dataToSend, t));
    } catch (error) {
      console.log(error);
    }
  };
  ...
  return (
    <>
      <Nav color={"primary"} />
      <div
        className="min-h-screen mt-6 bg-black flex items-center justify-center"
            ...
            <div className="grid gap-4 gap-y-2 text-sm grid-cols-1">
              ...
              <div className="md:col-span-5 text-right">
                <div className="inline-flex items-end">
                  <button
                    type="submit"
                    className="btn-primary w-full px-6 py-2 rounded text-white bg-blue-500 hover:bg-blue-600 focus:bg-blue-700 focus:ring-2 focus:ring-blue-600"
                  >
                    {t("adressUser.save")}
                  </button>
                </div>
