...
export const Products = () => {
  ...
  return (
    <>
      ...
      <div
        className={`max-w-screen text-center gap-4 ${
          theme === "dark" ? "text-white" : "bg-gray-300"
        }`}
        style={{
          backgroundColor: theme === "dark" ? "#212121" : "rgb(243, 244, 246)",
        }}
      >
        <div className="flex justify-center text-center mt-4 mb-8">
          <h1
            className="mb-7 text-4xl font-bold pb-2 text-gray-300 hover:drop-shadow-[0_35px_35px_rgba(0,0,0,.6)]"
