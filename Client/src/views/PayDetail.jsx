...
export const PayDetail = () => {
  ...
  const theme = themeLocal[0];
    ...
    const goBack = theme === "dark" ? "#212121" : "#F3F4F6";
            ...
            >
                <div className="order-info h-full w-[60%] p-6 flex justify-center relative box-border">
                    <div className="order-info-content w-full table-fixed">
                        <h2 className="mb-0 mt-1 text-center font-light text-lg">Order Summary</h2>
                        ...
                        <div className="total mt-6 text-lg absolute bottom-5 left-9 right-6">
                            <span className="float-left">
                                <div className="dense font-light text-base leading-snug">COMMISSION 15%</div>
                                <div className="dense font-light text-base leading-snug">Delivery</div>
                                TOTAL
                            </span>
                            <span className="float-right text-right">
                                <div className="dense font-light text-base leading-snug">${comission}</div>
                                <div className="dense font-light text-base leading-snug">$4.95</div>
                                ${finalTotal}
                            </span>
                        </div>
                    </div>
