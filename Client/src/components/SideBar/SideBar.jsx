...
const Sidebar = () => {
  ...
  return (
    <div className="flex items-start justify-left w-screen h-screen p-3 space-x-4 -mt-20">

      {/* <!-- Component Start --> */}
       {/* Condición para mostrar la primera o la segunda sidebar */}
      {expanded ? ( 
      <div className="flex flex-col items-center px-2 w-16 h-full overflow-hidden text-white bg-orange-400 rounded">
      ...
      <div className="flex flex-col items-center w-40 h-full overflow-hidden text-white bg-orange-400 rounded">
        <a className="flex items-center w-full px-2 mt-3" href="#"
        onClick={toggleSidebar}>
          <svg
            className="w-8 h-8 fill-current"
            xmlns="http://www.w3.org/2000/svg"
          ...
          <span className="ml-2 text-sm font-bolder">Filters & Orders</span>
        </a>
