export const createHtml = (paymentDetail) => {
    const { arrayProducts, name, amount } = paymentDetail;
    ...
    const htmlContent = `
        ...
        <body>
            <div style="border: 1px solid #ddd; padding: 20px; max-width: 600px; margin: 0 auto;">
                <img src="https://i.ibb.co/PFrSPtf/neoshoplogo.jpg" alt="Logo" style="width: 100%; max-width: 200px; display: block; margin: 0 auto 20px;">
