...
export const ProductCard = ({
  ...
  return (
    <article
      className="w-64 h-full rounded-xl bg-white p-3 shadow-lg hover:shadow-xl hover:transform hover:scale-105 duration-300 mb-6"
    ...
    >
      ...
      <div className="mt-1 p-2">
        <h2 className="text-slate-700" style={{ color: textColor }}>
          {name}
        </h2>
        ...
        <div className="mt-3 flex items-end justify-between">
          ...
          {available === false ? (
            <button
              ...
              disabled={true}
              className="flex text-sm cursor-not-allowed items-center space-x-1.5 rounded-lg bg-gray-500 px-4 py-1.5 text-white duration-100 hover:bg-gray-600"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
            ...
            <button
              onClick={() => onAddToCart()}
              color={textColorButton}
              className="flex text-sm cursor-pointer items-center space-x-1.5 rounded-lg bg-blue-500 px-4 py-1.5 text-white duration-100 hover:bg-blue-600"
